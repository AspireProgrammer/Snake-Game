...
public class GamePanel2 extends JPanel implements ActionListener
{
    ...
    //higher the number of the delay, the slower the game
    static final int DELAY = 100;

    //two array are the coordinate of the the head and body of the snake
    ...
    public void move()
    {   //to iterate the bodyparts of the snake
